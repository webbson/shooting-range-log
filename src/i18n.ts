...
const resources = {
  sv: {
    translation: {
      ...
      continue_without_weapon: 'Fortsätt utan vapen',
      assign_weapon_checkbox: 'Tilldela vapnet till medlemmen',
      assign_already: 'Redan tilldelat',
      assign_transfer_warning: 'Tilldelningen flyttas från {{name}}.',
  ...
  en: {
    translation: {
      ...
      continue_without_weapon: 'Continue without weapon',
      assign_weapon_checkbox: 'Assign weapon to member',
      assign_already: 'Already assigned',
      assign_transfer_warning: 'Assignment will transfer from {{name}}.',
