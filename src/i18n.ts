...
const resources = {
  sv: {
    translation: {
      ...
      wipe_all_button: 'Töm databasen',
      wipe_all_hint: 'Tar bort alla medlemmar, vapen och all historik. Inställningar behålls.',
      wipe_logs_button: 'Töm all historik',
      wipe_logs_hint: 'Tar bort utlämningar, service och skulder. Medlemmar och vapen behålls.',
      wipe_confirm_title: 'Töm databasen',
      wipe_irreversible: 'Detta går inte att ångra. Endast en återställning från en säkerhetskopia kan ta tillbaka datan.',
      wipe_done: 'Databasen är tömd',
      scanner_measure: 'Mät',
  ...
  en: {
    translation: {
      ...
      wipe_all_button: 'Wipe database',
      wipe_all_hint: 'Removes every member, weapon and all history. Settings are kept.',
      wipe_logs_button: 'Wipe all history',
      wipe_logs_hint: 'Removes checkouts, service and debts. Members and weapons are kept.',
      wipe_confirm_title: 'Wipe database',
      wipe_irreversible: 'This cannot be undone. Only a restore from a backup can bring the data back.',
      wipe_done: 'Database wiped',
